# dotenv
Shamelessly copied from [this year old pending pull-request on oh-my-zsh](https://github.com/robbyrussell/oh-my-zsh/pull/6093), in order to use it with [zplug](https://github.com/zplug/zplug)
